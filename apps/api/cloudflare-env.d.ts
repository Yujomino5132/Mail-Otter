/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config ./apps/api/wrangler.template.jsonc --env-interface CloudflareEnv ./apps/api/cloudflare-env.d.ts` (hash: 677a4ee5a459724427186f0d35cd1aca)
// Runtime types generated with workerd@1.20260504.1 2025-11-29 
declare namespace Cloudflare {
	interface Env {
		...
		EMAIL_PROCESSING_WORKFLOW: Workflow /* EmailProcessingWorkflow */;
	}
}
